...
public class Registration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else
			{
				...
				User user = new User(username,password,usertype,street,city,state,zip);
				hm.put(username, user);
			    MySqlDataStoreUtilities.insertUser(username,password,usertype,street,city,state,zip);
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>Street</h3></td><td><input type='text' name='street' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
