...
function createDataTable(jsonData) {
    ...
    for(var i=0; i<parsedData.length; i++) {
     ...
     headingArray[1] = "Items Available";
    ...
    for(var i=0; i<productNameArr.length; i++) {
        ...
        for(k=0; k<parsedData.length; k++) {
            if(parsedData[k]["productName"] === productNameArr[i]) {                    
                dataArr[1] = parseInt(parsedData[k]["itemsAvaialble"]);                   
            }                 
        }
    ...
    //     for(k=0; k<parsedData.length; k++) {
    //         if(parsedData[k]["productName"] == productNameArr[j]) {                    
