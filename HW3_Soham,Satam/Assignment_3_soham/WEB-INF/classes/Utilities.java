...
public class Utilities extends HttpServlet{
	...
	public void storeProduct(String name,String type,String maker, int quantity, String acc){
		...
		if(type.equals("tvs")){
			...
			if(!alreadyInCart){
				OrderItem orderitem = new OrderItem(tv.getId(),tv.getName(), tv.getPrice(), tv.getDiscount(), tv.getRebate(), quantity, tv.getImage(), tv.getRetailer());
		...
		if(type.equals("soundSystems")){
			...
			if(!alreadyInCart){
				OrderItem orderitem = new OrderItem(soundSystem.getId(),soundSystem.getName(), soundSystem.getPrice(),soundSystem.getDiscount(), soundSystem.getRebate(), quantity, soundSystem.getImage(), soundSystem.getRetailer());
				orderItems.add(orderitem);
			}
		}
		if(type.equals("phones")){
			...
			if(!alreadyInCart){
				OrderItem orderitem = new OrderItem(phone.getId(),phone.getName(), phone.getPrice(),phone.getDiscount(), phone.getRebate(), quantity, phone.getImage(), phone.getRetailer());
				orderItems.add(orderitem);
			}
		}
		if(type.equals("laptops")){
			...
			if(!alreadyInCart){
				OrderItem orderitem = new OrderItem(laptop.getId(),laptop.getName(), laptop.getPrice(),laptop.getDiscount(), laptop.getRebate(), quantity, laptop.getImage(), laptop.getRetailer());
				orderItems.add(orderitem);
			}
		}
		if(type.equals("voiceAssistants")){
			...
			if(!alreadyInCart){
				OrderItem orderitem = new OrderItem(voiceAssistant.getId(),voiceAssistant.getName(), voiceAssistant.getPrice(),voiceAssistant.getDiscount(), voiceAssistant.getRebate(), quantity, voiceAssistant.getImage(), voiceAssistant.getRetailer());
				orderItems.add(orderitem);
			}
		}
		if(type.equals("wearableTechs")){
			...
			if(!alreadyInCart){
				OrderItem orderitem = new OrderItem(wearableTech.getId(),wearableTech.getName(), wearableTech.getPrice(),wearableTech.getDiscount(),wearableTech.getRebate() ,quantity, wearableTech.getImage(), wearableTech.getRetailer());
				orderItems.add(orderitem);
			}
		}
		...
		if(type.equals("accessories")){	
			...
			if(!alreadyInCart){
				OrderItem orderitem = new OrderItem(accessory.getId(),accessory.getName(), accessory.getPrice(), accessory.getDiscount(), accessory.getRebate(),quantity, accessory.getImage(), accessory.getRetailer());
				orderItems.add(orderitem);
			}
		}
	}
	...
	public void storePayment(int orderId,
		String orderName,double orderPrice,double discount, double rebate, int quantity,String street,String city,String state,String zip,
		String creditCardNo, boolean pickup, String storeId, LocalDate orderDate, LocalDate receiveDate ){
		...
		try
		{	
			// MySqlDataStoreUtilities.insertOrder(orderpayment.getOrderId(),orderpayment.getUserName(),orderpayment.getOrderName(),
			// 									orderpayment.getOrderPrice(),orderpayment.getDiscount(),orderpayment.getFinalPrice(),
			// 									orderpayment.getQuantity(),orderpayment.getRebate(),orderpayment.getTotalCost(),
			// 									orderpayment.getCreditCardNo(),orderpayment.getPickup(),orderpayment.getShippingCost(),
			// 									orderpayment.getOrderDate(),orderpayment.getStreet(),orderpayment.getCity(),
			// 									orderpayment.getState(),orderpayment.getZip(),orderpayment.getStoreId());
