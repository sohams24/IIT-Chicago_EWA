	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'>"+
							"<option value='phones' selected>Phone</option>"+
							"<option value='tvs'>Telivision</option>"+
							"<option value='laptops'>Laptop</option>"+
							"<option value='soundSystems'>SoundSystem</option>"+
							"<option value='voiceAssistants'>Voice Assistant</option>"+
							"<option value='wearableTechs'>Wearable Technology</option>"+
		...
		}else if (action.equals("Updateproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "</td></tr><tr><td>"
					+ "<h3>Product Rebate</h3></td><td><input type='number' step='any' name='productRebate' value='' class='input' required></input>"
					+ "</td></tr><tr><td>"
