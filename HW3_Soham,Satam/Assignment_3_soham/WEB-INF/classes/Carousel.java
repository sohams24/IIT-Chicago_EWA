...
public class Carousel{
	...
	public String carouselfeature(Utilities utility){
		...
		System.out.println("Following are the phones in hm:");
		...
		{
			System.out.println("The order item id is: "+oi.getId());
			System.out.println("Inside the for loop.");
			if (hm.containsKey(oi.getId()))
			{	
				System.out.println("\nFound the phone: "+oi.getName()+"in our hashmap hm.");
				...
				*/
				...
				Phone phone1 = hm.get(oi.getId());
				// System.out.print(oi.getName());
				int k = 0; int size= hm.size();
			
				System.out.println("The accessories of "+phone1.getName()+" are as follows:");
